...
% % This code is modified based on Jie Liang version by Xiangyong Cao
...
%utilize the spatial smoothness, 
%apply a mean filter to the absolute values of wavelets coefficients
